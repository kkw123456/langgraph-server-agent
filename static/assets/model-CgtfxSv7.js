...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lc(e,t,n){let r=new Float32Array(Cc),i=new K(0,1,0);return new wo({name:`SphericalGaussianBlur`,defines:{n:Cc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Bc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Rc(){return new wo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Bc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zc(){return new wo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bc(),fragmentShader:`
	...
	`}var Vc=class extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new xa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=iu(i,i.VERTEX_SHADER,y),S=iu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=uu(i,x,`vertex`),n=uu(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,jf=class extends Error{},Mf=.1,Nf=20,Pf=1.2,Ff={light:{background:16317180,gridCenter:12175060,gridLine:14542317,hemisphereSky:16777215,hemisphereGround:14147304},dark:{background:857116,gridCenter:5399929,gridLine:2504004,hemisphereSky:14412542,hemisphereGround:1516081}},If=()=>{let e=document.createElement(`style`);return e.textContent=Af,e},Lf=(e,t,n)=>{let r=document.createElement(e);return t&&(r.className=t),n!==void 0&&(r.textContent=n),r},Rf=e=>{if(e instanceof Error)return e.message;if(typeof e==`string`)return e;try{return JSON.stringify(e)}catch{return String(e)}},zf=e=>{let t=e&&typeof e==`object`&&`name`in e?String(e.name||``):``;return t===`SecurityError`||t===`NetworkError`||/worker failed to load|worker-src|content security policy|importscripts|script error|loading (?:the )?wasm|fetching of the wasm failed/i.test(Rf(e))},Bf=(e,t)=>{let n=t.defaultView?.location;if(!n)return!0;try{let r=new URL(e,t.baseURI);return r.protocol===`blob:`||r.origin===n.origin}catch{return!0}},Vf=e=>{if(!e)return``;try{return new URL(`.`,e).href}catch{let t=e.split(/[?#]/)[0]||e,n=t.lastIndexOf(`/`);return n>=0?t.slice(0,n+1):``}},Hf=e=>{let t=new Set,n=new Set,r=new Set,i=new Set,a=e=>{e instanceof cn&&!r.has(e)&&(r.add(e),e.dispose())},o=e=>{n.has(e)||(n.add(e),Object.values(e).forEach(e=>{a(e),Array.isArray(e)&&e.forEach(a)}),e instanceof wo&&Object.values(e.uniforms).forEach(e=>{a(e?.value),Array.isArray(e?.value)&&e.value.forEach(a)}),e.dispose())};e.traverse(e=>{let n=e,r=e;n.geometry&&!t.has(n.geometry)&&(t.add(n.geometry),n.geometry.dispose()),n.material&&(Array.isArray(n.material)?n.material:[n.material]).forEach(o),r.material&&(Array.isArray(r.material)?r.material:[r.material]).forEach(o);let a=e;a.isSkinnedMesh&&!i.has(a.skeleton)&&(i.add(a.skeleton),a.skeleton.dispose())})};async function Uf(e,m,h=`glb`,g){let _=h.toLowerCase(),v=g?.url,y=s(g?.options),b=`loading`,x=``,S=y(`model.state.loadingSummary`),C=!1,w=!1,T=!0,E=!0,D=null,O=null,k=null,A=null,j=null,M=null,ee=null,te=null,ne=null,re=null,ie=null,ae=null,oe=null,se=!1,N=0,ce=0,le=0,P=0,ue=1,F=null,de=new Bs,fe=a(),pe=f(),me=Lf(`div`,`model-viewer`),he=Lf(`div`,`model-toolbar`),ge=Lf(`div`,`model-actions`),_e=Lf(`button`,void 0,y(`model.toolbar.fit`)),ve=Lf(`button`,void 0,y(`model.toolbar.rotate`)),ye=Lf(`button`,void 0,y(`model.toolbar.wireframe`)),be=Lf(`button`,void 0,y(`model.toolbar.grid`)),xe=Lf(`button`,void 0,y(`model.toolbar.axes`)),Se=Lf(`div`,`model-meta`),Ce=Lf(`strong`,void 0,_.toUpperCase()),we=Lf(`span`,void 0,S),Te=Lf(`div`,`model-stage`),Ee=document.createElement(`canvas`),De=Lf(`div`,`model-state`,y(`model.state.loading`)),Oe=[_e,ve,ye,be,xe];me.dataset.modelFormat=_,me.dataset.modelStatus=b,me.dataset.modelMeshCount=`0`,Oe.forEach(e=>{e.type=`button`}),ge.append(_e,ve,ye,be,xe),Se.append(Ce,we),he.append(ge,Se),Te.append(Ee,De),me.append(he,Te),m.replaceChildren(If(),me);let ke=()=>{if(typeof TextDecoder==`function`)return new TextDecoder(`utf-8`).decode(e);let t=new Uint8Array(e),n=``;for(let e=0;e<t.length;e+=1)n+=String.fromCharCode(t[e]);return n},Ae=()=>{ve.classList.toggle(`active`,C),ye.classList.toggle(`active`,w),be.classList.toggle(`active`,T),xe.classList.toggle(`active`,E),we.textContent=S,me.dataset.modelStatus=b,me.dataset.modelMeshCount=String(le),De.hidden=b===`ready`,De.classList.toggle(`error`,b===`error`),b===`loading`?De.textContent=y(`model.state.loading`):b===`error`&&De.replaceChildren(Lf(`strong`,void 0,y(`model.state.parseFailed`)),Lf(`span`,void 0,x))},je=()=>{M&&(M.visible=T),ee&&(ee.visible=E),Ae()},Me=e=>e?[e.x,e.y,e.z]:void 0,I=(e,t)=>{if(!Array.isArray(e))return t.clone();let[n,r,i]=e.map(Number);return!Number.isFinite(n)||!Number.isFinite(r)||!Number.isFinite(i)?t.clone():new K(n,r,i)},Ne=()=>{if(!k||!A||P<=0)return 1;let e=k.position.distanceTo(A.target);return e>0?Wt.clamp(P/e,Mf,Nf):1},L=()=>{let e=Ne(),t=b===`ready`&&!!(j&&k&&A&&P>0);return{scale:e,label:`${Math.round(e*100)}%`,canZoomIn:t&&e<19.999,canZoomOut:t&&e>.101,canReset:t&&Math.abs(e-1)>.005,minScale:Mf,maxScale:Nf}},Pe=(e,t=`api`,n=`zoom-change`,r=!0)=>{if(!k||!A||P<=0)return L();let i=Wt.clamp(e,Mf,Nf),a=k.position.clone().sub(A.target);return a.lengthSq()<1e-8&&a.set(1,.62,1),a.normalize(),k.position.copy(A.target).addScaledVector(a,P/i),k.updateProjectionMatrix(),A.update(),pe.emit(),r&&Fe(n,t),L()},R=()=>{let e=L();return{renderer:`model`,scale:e.scale,zoom:e,extra:{status:b,cameraPosition:Me(k?.position),cameraTarget:Me(A?.target),zoomBaselineDistance:P,autoRotate:C,wireframe:w,showGrid:T,showAxes:E}}},Fe=(e,t=`viewer`)=>{let n=R();return fe.emit(i(n,{action:e,source:t})),n},z=(e,t={})=>{let n=t.source||`api`,r=t.action||`restore`,i=t.notify!==!1,a=Number(e.extra?.zoomBaselineDistance);Number.isFinite(a)&&a>0&&(P=a);let o=Array.isArray(e.extra?.cameraPosition);k&&(k.position.copy(I(e.extra?.cameraPosition,k.position)),k.updateProjectionMatrix()),A&&(A.target.copy(I(e.extra?.cameraTarget,A.target)),A.update());let s=Number(e.scale??e.zoom?.scale);return!o&&Number.isFinite(s)&&s>0?Pe(s,n,r,!1):pe.emit(),typeof e.extra?.autoRotate==`boolean`&&(C=e.extra.autoRotate),typeof e.extra?.wireframe==`boolean`&&(w=e.extra.wireframe,vt()),typeof e.extra?.showGrid==`boolean`&&(T=e.extra.showGrid),typeof e.extra?.showAxes==`boolean`&&(E=e.extra.showAxes),je(),Ae(),i?Fe(r,n):R()},B=()=>{D&&k&&kf({renderer:D,camera:k,stage:Te,canvas:Ee,devicePixelRatio:m.ownerDocument.defaultView?.devicePixelRatio||1})},Ie=()=>{let e=me;for(;e;){if(e.hasAttribute(`data-viewer-theme`))return e;let t=e.parentElement;if(t){e=t;continue}let n=e.getRootNode();e=`host`in n?n.host:null}return null},Le=m.ownerDocument.defaultView?.matchMedia?.(`(prefers-color-scheme: dark)`),Re=()=>{let e=Ie()?.dataset.viewerTheme||g?.options?.theme;return p(e===`light`||e===`dark`||e===`system`?e:void 0,Le?.matches??!1)===`dark`},ze=e=>{if(!O)return;let t=e?Ff.dark:Ff.light,n=M,r=new ac(10,10,t.gridCenter,t.gridLine);r.visible=T,n&&(r.scale.copy(n.scale),O.remove(n),Hf(n)),M=r,O.add(r)},Be=(e=!1)=>{let t=Re();if(me.dataset.modelTheme=t?`dark`:`light`,!e&&ie===t)return;ie=t;let n=t?Ff.dark:Ff.light;D?.setClearColor(n.background,1),O&&(O.background=new X(n.background)),te&&(te.color.setHex(n.hemisphereSky),te.groundColor.setHex(n.hemisphereGround)),Ee.style.colorScheme=t?`dark`:`light`,ze(t)},Ve=()=>{let e=Ie(),t=m.ownerDocument.defaultView?.MutationObserver;if(e&&t&&(ne=new t(()=>Be()),ne.observe(e,{attributes:!0,attributeFilter:[`data-viewer-theme`]})),!Le)return;let n=()=>Be();typeof Le.addEventListener==`function`?(Le.addEventListener(`change`,n),re=()=>Le.removeEventListener(`change`,n)):(Le.addListener(n),re=()=>Le.removeListener(n))},He=()=>{let e=!O||!M;if(D||(D=new Td({antialias:!0,alpha:!1,canvas:Ee,powerPreference:`high-performance`}),D.outputColorSpace=nt),!O){O=new Yn,te=new ds(16777215,14147304,2.4),O.add(te);let e=new As(16777215,2.2);e.position.set(8,10,8),O.add(e);let t=new As(16777215,.9);t.position.set(-7,5,-4),O.add(t),ee=new oc(3),O.add(ee)}if(k||(k=new Cs(45,1,.01,1e5),k.position.set(5,4,6)),!A&&k&&D&&(A=new Fd(k,D.domElement),A.enableDamping=!0,A.dampingFactor=.08,A.screenSpacePanning=!0,A.autoRotateSpeed=1.2),Be(e),je(),B(),!A)throw Error(`Failed to initialize 3D controls.`);return A},Ue=()=>{j&&O&&(F?.stopAllAction(),F?.uncacheRoot(j),O.remove(j),Hf(j)),j=null,le=0,P=0,F=null,pe.emit()},We=()=>new Eo({color:5214138,metalness:.08,roughness:.78,side:2,wireframe:w}),Ge=()=>new ma({color:2062988,size:.035,sizeAttenuation:!0}),Ke=e=>{e.traverse(e=>{let t=e;t.isMesh&&!t.material&&(t.material=We()),t.isMesh&&t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(e=>{`wireframe`in e&&(e.wireframe=w),e.needsUpdate=!0})})},qe=e=>{let t=0,n=0;return e.traverse(e=>{e.isMesh&&(t+=1),e.isPoints&&(n+=1)}),{meshes:t,points:n}},Je=e=>{let{meshes:t,points:n}=qe(e);le=t;let r=[];t&&r.push(y(`model.summary.meshes`,{count:t})),n&&r.push(y(`model.summary.points`,{count:n})),S=r.length?r.join(` · `):y(`model.state.loaded`),Ae()},Ye=e=>{let t=new ur().setFromObject(e);if(t.isEmpty())return{center:new K,size:new K(4,4,4)};let n=t.getCenter(new K),r=t.getSize(new K);return e.position.sub(n),{center:new K,size:r}},Xe=(e=`viewer`,t)=>{if(!j||!k||!A)return L();let n=new ur().setFromObject(j),r=n.getCenter(new K),i=n.getBoundingSphere(new zr),a=Math.max(i.radius,.5),o=Te.getBoundingClientRect(),s=Math.max(1,o.width||Ee.clientWidth),c=Math.max(1,o.height||Ee.clientHeight),l=Math.max(.01,s/c),u=Wt.degToRad(k.fov),d=2*Math.atan(Math.tan(u/2)*l),f=a/Math.max(Math.sin(u/2),.01),p=a/Math.max(Math.sin(d/2),.01),m=t?.mode||`contain`,h=m===`cover`?Math.min(f,p):m===`width`?p:m===`height`?f:Math.max(f,p),g=Math.max(0,t?.padding??28),_=Wt.clamp(1-g*2/Math.min(s,c),.2,1);h=Math.max(h/_,.01);let v=k.position.clone().sub(A.target);return v.lengthSq()<1e-8&&v.set(1,.62,1),v.normalize(),P=h,k.near=Math.max(h/1e3,.01),k.far=Math.max(h*1e3,1e3),k.position.copy(r).addScaledVector(v,h),k.updateProjectionMatrix(),A.target.copy(r),A.minDistance=h/Nf,A.maxDistance=h/Mf,A.update(),pe.emit(),Fe(`fit`,e),L()},Ze=e=>{if(!j||!k||!A)return{applied:!1,mode:e.mode,resize:e.resize,source:e.source,reason:`not-ready`,provider:`view-state`};let t=Xe(e.source,e),n=R();return{applied:!0,mode:e.mode,resize:e.resize,scale:t.scale,source:e.source,provider:`view-state`,state:n}},Qe=async e=>{if(!O)return;Ue(),Ke(e);let{size:t}=Ye(e);j=e,O.add(e),Xe(),Je(e);let n=Math.max(t.x,t.y,t.z,1);M&&M.scale.setScalar(Math.max(n/10,1))},$e=async()=>{let{GLTFLoader:n}=await t(async()=>{let{GLTFLoader:e}=await import(`./GLTFLoader-BcBLVHkA.js`);return{GLTFLoader:e}},[]),r=new n,i=Vf(v),a=_===`gltf`?ke():e;return await new Promise((e,t)=>{r.parse(a,i,t=>{t.animations?.length&&(F=new rc(t.scene),t.animations.forEach(e=>F?.clipAction(e).play())),e(t.scene)},t)})},et=async()=>{let{OBJLoader:e}=await t(async()=>{let{OBJLoader:e}=await import(`./OBJLoader-BlScA6-R.js`);return{OBJLoader:e}},[]);return new e().parse(ke())},tt=async()=>{let{STLLoader:n}=await t(async()=>{let{STLLoader:e}=await import(`./STLLoader-C_hrgMOo.js`);return{STLLoader:e}},[]),r=new n().parse(e);return r.computeVertexNormals(),new yi(r,We())},rt=async()=>{let{PLYLoader:n}=await t(async()=>{let{PLYLoader:e}=await import(`./PLYLoader-Bg_R-VPP.js`);return{PLYLoader:e}},[]),r=new n().parse(e);return r.computeVertexNormals(),new yi(r,We())},it=async()=>{let{FBXLoader:n}=await t(async()=>{let{FBXLoader:e}=await import(`./FBXLoader-CbGhMwnD.js`);return{FBXLoader:e}},__vite__mapDeps([3,4])),r=new n().parse(e,Vf(v));return r.animations?.length&&(F=new rc(r),r.animations.forEach(e=>F?.clipAction(e).play())),r},at=async()=>{let{ColladaLoader:e}=await t(async()=>{let{ColladaLoader:e}=await import(`./ColladaLoader-Bt6n7tEm.js`);return{ColladaLoader:e}},[]),n=new e().parse(ke(),Vf(v));if(!n?.scene)throw Error(y(`model.error.daeEmpty`));return n.scene},ot=async()=>{let{TDSLoader:n}=await t(async()=>{let{TDSLoader:e}=await import(`./TDSLoader-CESzRayO.js`);return{TDSLoader:e}},[]);return new n().parse(e,Vf(v))},st=async()=>{let{ThreeMFLoader:n}=await t(async()=>{let{ThreeMFLoader:e}=await import(`./3MFLoader-DtBpVEIu.js`);return{ThreeMFLoader:e}},__vite__mapDeps([5,4]));return new n().parse(e)},ct=async()=>{let{AMFLoader:n}=await t(async()=>{let{AMFLoader:e}=await import(`./AMFLoader-7u9L1M27.js`);return{AMFLoader:e}},__vite__mapDeps([6,4]));return new n().parse(e)},lt=async()=>{let{USDLoader:n}=await t(async()=>{let{USDLoader:e}=await import(`./USDLoader-DgtYnJ1r.js`);return{USDLoader:e}},__vite__mapDeps([7,4]));return new n().parse(e)},ut=async()=>{let{KMZLoader:n}=await t(async()=>{let{KMZLoader:e}=await import(`./KMZLoader-BYyypvXq.js`);return{KMZLoader:e}},__vite__mapDeps([8,4,9]));return new n().parse(e).scene},dt=async t=>{let i=g?.options?.model,a=n(m.ownerDocument),o=r(i,a),s=Object.fromEntries([[`linearUnit`,i?.linearUnit],[`linearDeflectionType`,i?.linearDeflectionType],[`linearDeflection`,i?.linearDeflection],[`angularDeflection`,i?.angularDeflection]].filter(([,e])=>e!==void 0)),c=i?.useWorker!==!1&&Bf(o.workerUrl,m.ownerDocument),l={...o,useWorker:c,timeoutMs:i?.workerTimeoutMs,params:s,signal:g?.signal};me.dataset.modelImport=c?`worker`:`main-thread`;let u;try{u=await of(e,t,l)}catch(n){if(!c||g?.signal?.aborted||!zf(n))throw n;me.dataset.modelImport=`main-thread-fallback`;try{u=await of(e,t,{...l,useWorker:!1})}catch(e){throw Error(`${Rf(n)} Main-thread fallback failed: ${Rf(e)}`)}}return Df(u,w).object},ft=t=>{let n=_f(e,t),r=vf(n.format||t,o(g?.options));throw new jf(`${n.signature?y(`model.notice.signature`,{signature:n.signature}):``}${r}${n.warnings.length?` ${n.warnings.join(` `)}`:``}`)},pt=async()=>{let{PCDLoader:n}=await t(async()=>{let{PCDLoader:e}=await import(`./PCDLoader-CzxXNl2j.js`);return{PCDLoader:e}},[]);return new n().parse(e,v||`model.pcd`)},mt=async()=>{let{VRMLLoader:e}=await t(async()=>{let{VRMLLoader:e}=await import(`./VRMLLoader-CTHGYPQF.js`);return{VRMLLoader:e}},[]);return new e().parse(ke(),Vf(v))},ht=async()=>{let{XYZLoader:e}=await t(async()=>{let{XYZLoader:e}=await import(`./XYZLoader-Cf73X3_L.js`);return{XYZLoader:e}},[]),n=new e().parse(ke());return n.computeBoundingSphere(),new ya(n,Ge())},V=async()=>{let{VTKLoader:n}=await t(async()=>{let{VTKLoader:e}=await import(`./VTKLoader-plHWMA0i.js`);return{VTKLoader:e}},__vite__mapDeps([10,4])),r=new n().parse(e);return r.computeVertexNormals(),new yi(r,We())},H=e=>{switch(e){case`glb`:case`gltf`:return $e();case`obj`:return et();case`stl`:return tt();case`ply`:return rt();case`fbx`:return it();case`dae`:return at();case`3ds`:return ot();case`3mf`:return st();case`amf`:return ct();case`usd`:case`usda`:case`usdc`:case`usdz`:return lt();case`kmz`:return ut();case`step`:case`stp`:case`iges`:case`igs`:case`brep`:return dt(e);case`ifc`:case`3dm`:return ft(e);case`pcd`:return pt();case`wrl`:case`vrml`:return mt();case`xyz`:return ht();case`vtk`:case`vtp`:return V();default:if(pf(e))return ft(e);throw Error(y(`model.error.unsupported`,{type:e}))}},gt=async()=>{let e=++ce;b=`loading`,x=``,le=0,S=y(`model.state.loadingSummary`),Ae(),He();try{let t=await H(_);if(e!==ce){Hf(t);return}await Qe(t),b=`ready`,Ae(),pe.emit(),Fe(`init`,`viewer`)}catch(t){if(e!==ce||g?.signal?.aborted)return;throw t instanceof jf||console.error(t),b=`error`,le=0,x=Rf(t)||y(`model.error.parseFailed`,{type:_.toUpperCase()}),Ae(),pe.emit(),t instanceof Error?t:Error(x)}},_t=e=>{if(!D||!O||!k||!A)return;B(),de.update(e);let t=de.getDelta();A.autoRotate=C,A.update(t),F?.update(t),D.render(O,k),N=window.requestAnimationFrame(_t)},vt=()=>{j&&Ke(j),Ae()},yt=()=>{ue=Ne()},bt=()=>{let e=Ne();if(Math.abs(e-ue)>.002){pe.emit(),Fe(`zoom-change`,`user`);return}Fe(`camera-change`,`user`)};_e.addEventListener(`click`,()=>Xe(`user`)),ve.addEventListener(`click`,()=>{C=!C,Ae(),Fe(`view-option-change`,`user`)}),ye.addEventListener(`click`,()=>{w=!w,vt(),Fe(`view-option-change`,`user`)}),be.addEventListener(`click`,()=>{T=!T,je(),Fe(`view-option-change`,`user`)}),xe.addEventListener(`click`,()=>{E=!E,je(),Fe(`view-option-change`,`user`)});let xt=()=>{se||(se=!0,ce+=1,window.cancelAnimationFrame(N),ae?.disconnect(),ae=null,ne?.disconnect(),ne=null,re?.(),re=null,Ue(),oe?.removeEventListener(`start`,yt),oe?.removeEventListener(`end`,bt),oe=null,c(me),l(me),A?.dispose(),A=null,O&&Hf(O),D?.dispose(),D?.renderLists.dispose(),D=null,de.dispose(),O=null,k=null,M=null,ee=null,te=null,m.replaceChildren())};try{Ae(),oe=He(),Ve(),oe.addEventListener(`start`,yt),oe.addEventListener(`end`,bt),u(me,{zoomIn:()=>Pe(Ne()*Pf,`user`,`zoom-in`),zoomOut:()=>Pe(Ne()/Pf,`user`,`zoom-out`),resetZoom:()=>Pe(1,`user`,`zoom-reset`),setZoom:e=>Pe(e,`api`,`zoom-change`),fit:Ze,getState:L,subscribe:pe.subscribe}),d(me,{getState:R,applyState:z,fit:Ze,subscribe:fe.subscribe}),ae=new ResizeObserver(B),ae.observe(Te),de.connect(m.ownerDocument),_t(),await gt()}catch(e){throw xt(),e}return{$el:me,unmount(){xt()}}}export{Do as $,Io as A,Ar as At,w as B,Li as C,ho as Ct,kr as D,lr as Dt,Nr as E,ls as Et,ea as F,Qr as G,ns as H,pa as I,Y as J,Wt as K,fa as L,Ke as M,K as Mt,qe as N,ln as Nt,Jr as O,Mr as Ot,ca as P,Jo as Pt,Oo as Q,C as R,Fs as S,zr as St,jr as T,cn as Tt,Ns as U,rt as V,es as W,si as X,yi as Y,ko as Z,As as _,nt as _t,Ta as a,Wo as at,Fr as b,Ii as bt,Ea as c,Cs as ct,J as d,Uf as default,ma as dt,Eo as et,Oa as f,ec as ft,cs as g,_ as gt,Ni as h,Ms as ht,ur as i,x as it,Ye as j,G as jt,Xr as k,Pr as kt,v as l,Ds as lt,Da as m,Ko as mt,Yo as n,b as nt,Or as o,Bn as ot,ka as p,Gt as pt,q,Mi as r,S as rt,qr as s,Os as st,js as t,y as tt,X as u,ya as ut,Cn as v,Yn as vt,Gi as w,Ts as wt,Vn as x,ji as xt,as as y,uo as yt,T as z};