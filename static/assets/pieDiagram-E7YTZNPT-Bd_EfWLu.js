import{n as e}from"./mermaid-parser.core-Bk-WpKYY.js";import{t}from"./ordinal-BDEzSJ7C.js";import{t as n}from"./arc-B2-QRsRH.js";import{t as r}from"./pie-DvM8UMw-.js";import{i,p as a}from"./chunk-75Z2AOVW-BURtNo9N.js";import{n as o}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{t as s}from"./src-CUyS0zxD.js";import{H as c,K as l,U as u,a as d,c as f,f as p,v as m,w as h,x as g,y as _}from"./chunk-DU6HZSFF-DS0m4MOp.js";import{t as v}from"./chunk-JWPE2WC7-DVXcaiue.js";import{f as y}from"./mermaid.core-BilCrGeJ.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:o(()=>structuredClone(w),`getConfig`),clear:o(()=>{S=new Map,C=x.showData,d()},`clear`),setDiagramTitle:l,getDiagramTitle:h,setAccTitle:u,getAccTitle:_,setAccDescription:c,getAccDescription:m,addSection:o(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),s.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:o(()=>S,`getSections`),setShowData:o(e=>{C=e},`setShowData`),getShowData:o(()=>C,`getShowData`)},E=o((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:o(async t=>{let n=await e(`pie`,t);s.debug(n),E(n,T)},`parse`)},O=o(e=>`
  .pieCircle{
