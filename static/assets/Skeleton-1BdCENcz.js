import{$n as e,B as t,Gt as n,Hn as r,In as i,Ln as a,Lt as o,Sr as s,Vt as c,Zt as l,fr as u,l as d,mr as f,nn as p,rr as m,sr as h,ur as g}from"./index-COWK34nn.js";var _=!1;function v(){if(t&&window.CSS&&!_&&(_=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}var y=i([a(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
