import{$n as e,An as t,Bn as n,Ft as r,Gt as i,Jn as a,Mt as o,N as s,Ot as c,Tn as l,Vt as u,Wn as d,Zn as f,cr as p,l as m,tr as h,wn as g}from"./index-Co1niah7.js";var _=!1;function v(){if(s&&window.CSS&&!_&&(_=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}var y=g([l(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
