import{t as e}from"./createLucideIcon-BVttscYv.js";import{An as t,Bn as n,Ft as r,Gt as i,Mt as a,N as o,Ot as s,Qn as c,Tn as l,Un as u,Vt as d,Xn as f,er as p,l as m,qn as h,sr as g,wn as _}from"./index-4ZsUaYAJ.js";var v=!1;function y(){if(o&&window.CSS&&!v&&(v=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}var b=_([l(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
